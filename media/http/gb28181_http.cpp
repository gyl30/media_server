                                                      ...
                                                      boost::asio::ip::address bind_address)
{
    ...
    signaling_client::instance().report(gb28181_event::source_stopped(identity->stream_id, identity->stream_name, runtime_end_reason::requested));
    session->shutdown();
                                                    ...
                                                    boost::asio::ip::address bind_address)
{
    ...
    signaling_client::instance().report(gb28181_event::output_stopped(identity->stream_id, identity->stream_name, runtime_end_reason::requested));
    session->shutdown();
